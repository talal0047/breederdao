...
AbreederdaoTestCharacter::AbreederdaoTestCharacter()
{
...
void AbreederdaoTestCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
	...
	UUserWidget* MyWidget = CreateWidget<UUserWidget>(GetWorld(), HUDWidgetClass);
	if (MyWidget)
	{
...
void AbreederdaoTestCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AbreederdaoTestCharacter::Move);
...
void AbreederdaoTestCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AbreederdaoTestCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
